...
const updateData = () => {
    ...
    const DrawerList =()=> (
        ...
        <div className='pt-5 h-full w-full flex flex-col gap-5 px-5'>
            <div className='flex justify-end'><RxCross2 className='text-2xl cursor-pointer' onClick={toggleDrawer(false)}/></div>
           <div className='flex justify-between items-center'>
           <div className='text-2xl font-bold text-[#e69743]'>Request Under Reporting Person Approval</div>
           <div className='flex flex-col'>
            <label htmlFor=""><b>Search</b></label>
            <input type="text" className='border border-black w-[400px] h-[40px] rounded' />
           </div>
           <div>
            <img src="/login.png" alt="" style={{height:"30px" , width:"150px"}} />
           </div>
           </div>
        <table>
            <thead>
  ...
  return (
    <div>
        <Header/>
        <div className='bg-gray-200 dashboard-container px-4 flex flex-col gap-10'>
            <div className='grid grid-cols-3 gap-10 '>
            <div className="bg-gradient-to-r rounded-xl from-purple-500 to-purple-700 p-8" onClick={()=>setOpen(true)}>
            <div className="text-[24px] text-white flex items-center gap-2 ">0 <BsArrowUpRightCircle className='opacity-50'/></div>
          ...
          <div className="bg-gradient-to-r from-cyan-500 to-cyan-700 rounded-xl p-8 " onClick={()=>setOpen(true)}>
            ...
            <div className="bg-gradient-to-r rounded-xl bg-white px-8 flex gap-4 items-center " onClick={()=>setOpen(true)}>
                <div className='bg-sky-200 text-sky-600 h-10 w-14 flex justify-center items-center text-[30px] rounded-lg'><CiCreditCard1 /></div>
          <div className='text-gray-400'>
          <div className="text-[24px]  flex items-center gap-2 ">0 <BsArrowUpRightCircle className='opacity-50'/></div>
            ...
            <div className="bg-gradient-to-r rounded-xl bg-white p-8 flex gap-4 items-center " onClick={()=>setOpen(true)}>
                <div className='bg-green-200 text-green-600 h-10 w-14 flex justify-center items-center text-[30px] rounded-lg'><CiCreditCard1 /></div>
          <div className='text-gray-400'>
          <div className="text-[24px]  flex items-center gap-2 ">0 <BsArrowUpRightCircle className='opacity-50'/></div>
